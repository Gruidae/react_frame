...
import { PAGE_TITLE_CASE_LIST } from '../constants';
...
class AllCaseListPage extends React.Component {

  componentDidMount() {
    this.props.enhance.setTitle(PAGE_TITLE_CASE_LIST);
  }

  render() {
    return (
      <CaseListPage
        caseListType={caseActions.caseListType.ALL_CASES}
        filterItems={['全部', '最近提交', '重要紧急程度']}
        {...this.props}
      />
    );
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(Enhance(AllCaseListPage));

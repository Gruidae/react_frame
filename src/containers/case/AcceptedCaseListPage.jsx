...
import { PAGE_TITLE_ACCEPTED_CASES } from '../constants';
...
class AcceptedCaseListPage extends React.Component {

  componentDidMount() {
    this.props.enhance.setTitle(PAGE_TITLE_ACCEPTED_CASES);
  }

  render() {
    return (
      <CaseListPage
        caseListType={caseActions.caseListType.MY_ACCEPTED_CASES}
        filterItems={['全部', '最新受理', '最近沟通']}
        {...this.props}
      />
    );
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(Enhance(AcceptedCaseListPage));

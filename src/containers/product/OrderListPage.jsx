...
import { PAGE_TITLE_BIDDEN_PRODUCTS } from '../constants';
...
class OrderListPage extends React.Component {
  ...
  componentDidMount() {
    this.props.enhance.setTitle(PAGE_TITLE_BIDDEN_PRODUCTS);
  }

  render() {
    return (
      <ProductListPage
        productListType={productActions.productListType.MY_BIDDING_PRODUCTS}
        selectedIndex={this.props.sortType}
        filterItems={['全部', '最近接单', '最近联系']}
        {...this.props}
      />
    );
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(Enhance(OrderListPage));
